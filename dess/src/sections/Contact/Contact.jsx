...
function Contact() {
    return (
        <section id="contact" className="section-shell overflow-hidden w-full py-16 md:py-24">
            <div className="surface-card mx-auto flex max-w-350 flex-col justify-center gap-16 rounded-3xl bg-[#F7EAF9] px-6 py-10 shadow-[0_20px_60px_rgba(98,0,112,0.06)] md:flex-row">
                ...
                <div className="animate-fade-up anim-delay-1 flex w-full max-w-100 flex-col gap-6 md:w-[45%]">
                    ...
                    <form action="">
                        <input type="text" placeholder="Nome" className="premium-input w-full mb-4 px-4 py-2 border border-gray-300 rounded-md focus:outline-none" />
                        <input type="email" placeholder="Email" className="premium-input w-full mb-4 px-4 py-2 border border-gray-300 rounded-md focus:outline-none" />
                        <input type="number" placeholder="WhatsApp" className="premium-input w-full mb-4 px-4 py-2 border border-gray-300 rounded-md focus:outline-none" />
                        <textarea placeholder="Mensagem" className="premium-input w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none"></textarea>
                    </form>
                    <div>
