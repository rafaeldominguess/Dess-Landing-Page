      ...
      <div className="relative mx-auto flex max-w-350 items-center justify-evenly gap-12 px-6">
        ...
        <div className="max-w-md text-(--color-servicesheader) animate-fade-up anim-delay-1">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-sm font-semibold text-(--color) uppercase tracking-wider">
              Studio de Design
            </span>
          </div>

          <h1 className="text-4xl font-extrabold mb-6 leading-tight md:text-5xl">
            O olhar que reflete a sua{" "}
            <span className="text-(--color) relative">melhor versão</span>
          </h1>

          <p className="mb-8 text-lg leading-relaxed">
            Mais do que um design, busco realçar a harmonia do seu rosto e a
            força da sua expressão. No Studio, cada detalhe é pensado para que
            você se sinta ainda mais confiante e radiante. Agende seu horário e
